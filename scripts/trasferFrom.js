...
const tokenContractInstance = tokenContract.at('0xd9145CCE52D386f254917e481eB44e9943F39138');
const toAddress = '0xD329B5BF132931c88dca410AC712e5C6FBBCE89F';
​
...
const calculatedTransferFromValue = web3.toHex(tokenAmountToTransferFrom.mul(web3.toBigNumber(10).pow(tokenDecimals)));
​
// Get user account wallet address first
web3.eth.getAccounts(function(error, accounts) {
  if (error) throw error;
  // Send ERC20 transaction with web3
  tokenContractInstance.transferFrom.sendTransaction(toAddress, calculatedTransferFromValue, {from: accounts[0]}, function(error, txnHash) {
    if (error) throw error;
    console.log(txnHash);
  });
});
